...
<style>
  ...
  .stButton > button:hover { background: #cef080 !important; }
</style>
...
Responda em markdown com 3 seções exatamente nesta ordem:
...
Ao final da tabela, adicione uma linha de TOTAL GERAL.
